...
import { Sparkles, Mic, Image as ImageIcon, Send } from 'lucide-react';
...
const InputNode = ({ data }) => {
    ...
    const handleAction = () => {
        data.onGenerate(text, image);
    };

    return (
        <div className="glass p-6 w-[320px] shadow-2xl border-indigo-500/20 relative">
            ...
            <textarea
                className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-sm focus:border-indigo-500 outline-none min-h-[100px] resize-none"
            ...
            <div className="flex gap-2 mt-4">
                ...
                <button
                    ...
                    className="flex-[2] p-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 flex items-center justify-center gap-2 transition-all font-bold text-sm"
                >
                    <Send size={16} /> Gerar
                </button>
            </div>
